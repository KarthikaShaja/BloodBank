		...
		<div class="container">
			<form action="donor_add_process.jsp">
				...
				<select id="bld_grp" name="txtBloodGrp">
					...
					<option value="O%2Bve">O+ve</option>
					<option value="A-ve">A-ve</option>
					<option value="A%2Bve">A+ve</option>
					<option value="B-ve">B-ve</option>
					<option value="B%2Bve">B+ve</option>
					<option value="AB-ve">AB-ve</option>
					<option value="AB%2Bve">AB+ve</option>
				...
				<input type="text" name="txtPhone" id="txtPhone"
					pattern="[6789][0-9]{9}" placeholder="Your contact no is.."
					required><br> <br> <label for="height">Height</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
